...
public unsafe struct JiggleTreeJobData {
    ...
    public bool Equals(JiggleTreeJobData other) {
        return rootID == other.rootID
            ...
            && transformIndexOffset == other.transformIndexOffset
            && colliderIndexOffset == other.colliderIndexOffset
            && colliderCount == other.colliderCount
            && minExtentPosition.Equals(other.minExtentPosition)
            && maxExtentPosition.Equals(other.maxExtentPosition)
            && points == other.points
    ...
    public override int GetHashCode() {
        ...
        hash.Add(rootID);
        hash.Add(pointCount);
        hash.Add(transformIndexOffset);
        hash.Add(colliderIndexOffset);
        hash.Add(colliderCount);
        hash.Add(minExtentPosition);
        hash.Add(maxExtentPosition);
        hash.Add((IntPtr)points);
        hash.Add((IntPtr)parameters);
